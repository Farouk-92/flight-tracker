  ...
  return (
    <div className="App" style={{ height: '100vh', width: '100vw' }}>
      ...
      >
        ...
        {/* Draw flight routes and show planes along the routes */}
        {flights.map((flight) => {
                ...
                >
                  <Popup>
                    <div>
                      ...
                      <p>Callsign: {flight.callsign || 'Unknown'}</p>
                      <p>Country: {flight.origin_country}</p>
                      <p>Altitude: {flight.baro_altitude ? Math.round(flight.baro_altitude * 3.28084) : 'Unknown'} ft</p>
                      <p>Speed: {flight.velocity ? Math.round(flight.velocity * 1.94384) : 'Unknown'} knots</p>
